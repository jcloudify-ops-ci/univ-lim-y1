package fr.univ.lim.endpoint.event.consumer;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("fr.univ.lim.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "fr.univ.lim.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
