...
import fr.univ.lim.conf.FacadeIT;
import fr.univ.lim.endpoint.event.consumer.model.ConsumableEvent;
import fr.univ.lim.endpoint.event.consumer.model.ConsumableEventTyper;
import fr.univ.lim.endpoint.event.consumer.model.TypedEvent;
import fr.univ.lim.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("fr.univ.lim.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent = new TypedEvent("fr.univ.lim.endpoint.event.model.UuidCreated", payload);
